...
namespace GraphX.Common.Models
{
    ...
    public abstract class ObservableObject : INotifyPropertyChanged, INotifyPropertyChanging
    {
        ...
        {
            taskNotifier = taskNotifier ?? new TaskNotifier<T>();
            return SetPropertyAndNotifyOnCompletion(taskNotifier, newValue, _ => { }, propertyName);
        }
        ...
        protected sealed class TaskNotifier : ITaskNotifier<Task>
        {
            ...
            public static implicit operator Task(TaskNotifier notifier) => notifier?.task;
        }
        ...
        protected sealed class TaskNotifier<T> : ITaskNotifier<Task<T>>
        {
            ...
            /// </summary>
            /// <param name="notifier">The input <see cref="TaskNotifier{TTask}"/> instance.</param>
            public static implicit operator Task<T>(TaskNotifier<T> notifier) => notifier?.task;
        }
    }
}