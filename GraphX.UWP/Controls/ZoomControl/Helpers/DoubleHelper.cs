...
namespace GraphX.Controls
{
    internal static class DoubleHelper
    {
        ...
        {
            return AreVirtuallyEqual(new Point(r1.Top, r1.Left), new Point(r2.Top, r2.Left))
                && AreVirtuallyEqual(new Point(r1.Bottom, r1.Right), new Point(r2.Bottom, r2.Right));
        }
        ...
        public static bool IsNaN(double value)
        {
            ...
            NanUnion t = new() { DoubleValue = value };
