...
namespace GraphX.Controls
{
    ...
    public static class DragBehaviour
    {
        ...
        private static void OnDragStarted(object sender, PointerRoutedEventArgs e)
        {
            ...
            GraphAreaBase area = GetAreaFromObject(obj);
            Point pos = GetPositionInArea(area, e);
            ...
            foreach (VertexControl item in area.GetAllVertexControls())
            {
        ...
        private static void UpdateCoordinates(GraphAreaBase area, DependencyObject obj, double horizontalChange, double verticalChange, SnapModifierFunc xSnapModifier, SnapModifierFunc ySnapModifier)
        {
            ...
            //move the object
            double x = GetOriginalX(obj) + horizontalChange;
            ...
            double y = GetOriginalY(obj) + verticalChange;
        ...
        private static Point GetPositionInArea(GraphAreaBase area, PointerRoutedEventArgs e)
        {
            if (area != null)
            {
                Point pos = e.GetCurrentPoint(area).Position;
                return pos;
            }
        ...
        private static GraphAreaBase GetAreaFromObject(object obj)
        {
            ...
            else if (obj is DependencyObject dpobj)
            {
                area = VisualTreeHelperEx.FindAncestorByType(dpobj, typeof(GraphAreaBase), false) as GraphAreaBase;
            }
