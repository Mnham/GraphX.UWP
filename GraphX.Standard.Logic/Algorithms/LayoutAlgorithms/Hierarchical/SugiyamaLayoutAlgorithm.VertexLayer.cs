...
namespace GraphX.Logic.Algorithms.LayoutAlgorithms
{
        ...
        where TGraph : IVertexAndEdgeListGraph<TVertex, TEdge>, IMutableVertexAndEdgeSet<TVertex, TEdge>
    {
        private class VertexLayer : List<SugiVertex>
        {
            ...
            /// </summary>
            public IEnumerable<SugiEdge> UpEdges => this.SelectMany(v => Graph.InHierarchicalEdges(v));

            /// <summary>
            /// List of the hierarhical edges goes out from this layer.
            /// </summary>
            public IEnumerable<SugiEdge> DownEdges => this.SelectMany(v => Graph.OutHierarchicalEdges(v));
            ...
            public new void AddRange(IEnumerable<SugiVertex> vertices)
            {
                ...
                foreach (SugiVertex v in vertices)
                {
            ...
            {
                SugiVertex[] orderedVertices = (from v in this
                ...
                while (startIndex < orderedVertices.Length)
                {
                    ...
                    int border = (int)Math.Ceiling(count / (float)2.0);
