...
namespace GraphX.Logic.Algorithms.LayoutAlgorithms
{
        ...
        where TParam : class, ILayoutParameters
    {
        ...
        protected static void NormalizePositions(IDictionary<TVertex, Point> vertexPositions)
        {
            ...
            Point topLeft = new Point(float.PositiveInfinity, float.PositiveInfinity);
            foreach (Point pos in vertexPositions.Values.ToArray())
            {
            ...
            foreach (KeyValuePair<TVertex, Point> v in vertexPositions.ToArray())
            {
                Point pos = v.Value;
                pos.X -= topLeft.X;
                pos.Y -= topLeft.Y;
